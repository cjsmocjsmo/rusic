...
def docker_command(arch, version):
    docker_command = [
            ...
            "-v", f"{os.path.expanduser('~')}/NFSShare/Music:/usr/share/rusic/rusic/Music",
...
def main():
    ...
    if os.uname().machine == "armv7l":
        rpi3 = glob("/usr/share/rusic/rusic/setup/rusicsetup-rpi3b-*")
        ...
        rpi4 = glob("/usr/share/rusic/rusic/setup/rusicsetup-rpi4-*")
