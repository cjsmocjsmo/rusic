...
def main():
    ...
    if os.uname().machine == "armv7l":
        if os.path.exists("/usr/share/rusic/rusic/setup/rusicsetup-rpi3b-0.1.0"):
            subprocess.run(["/usr/share/rusic/rusic/setup/rusicsetup-rpi3b-0.1.0"])
        else:
            print("Rusic Setup not found. Please install it first.")
            exit(1)
        ...
        if os.path.exists("/usr/share/rusic/rusic/setup/rusicsetup-rpi4-0.1.0"):
            subprocess.run(["/usr/share/rusic/rusic/setup/rusicsetup-rpi4-0.1.0"])
        else:
            print("Rusic Setup not found. Please install it first.")
            exit(1)
